module.exports = plop => {
  ...
  plop.setGenerator('service', {
    ...
    actions: [
      {
        type: 'add',
        path: './services/controllers/{{pascalCase name}}/{{pascalCase name}}.service.ts',
        templateFile: 'plop-templates/services/index.ts.hbs',
      },
      {
        type: 'add',
        path: './services/controllers/{{pascalCase name}}/urls.ts',
      ...
      {
        type: 'add',
        path: './services/controllers/{{pascalCase name}}/models/result.model.ts',
        templateFile: 'plop-templates/services/models/result.model.ts.hbs',
      },
      {
        type: 'add',
        path: './services/controllers/{{pascalCase name}}/models/index.ts',
